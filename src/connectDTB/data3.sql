...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th4 25, 2024 lúc 10:23 AM
...
INSERT INTO `bill` (`bill_ID`, `Time`, `Total`, `Status`, `Cus_Phone`, `Table_ID`, `Emp_ID`) VALUES
(1, '2024-04-24 00:00:00', 600000, 1, '0339402833', 1, 101200),
(2, '2024-04-13 00:00:00', 500000, 1, '0738392732', 2, 108796),
(3, '2024-01-25 00:00:00', 700000, 1, '0849283928', 4, 155064),
(4, '2024-03-25 00:00:00', 850000, 1, '0842938333', 5, 896532);
...
(1, 'Cao Hoang', '0993890211', '11 Nam Cao', 'Employee', '001122'),
...
--
-- Cấu trúc bảng cho bảng `food&drink_category`
--

CREATE TABLE `food&drink_category` (
  `ID` int(11) NOT NULL,
  `Name` text NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `food&drink_category`
--

INSERT INTO `food&drink_category` (`ID`, `Name`, `Price`, `Quantity`, `Classify`) VALUES
...
INSERT INTO `order_details` (`bill_ID`, `item_ID`, `Quantity`) VALUES
(1, 101, 3),
(1, 202, 4);
...
--
-- Chỉ mục cho bảng `food&drink_category`
--
ALTER TABLE `food&drink_category`
  ADD PRIMARY KEY (`ID`);
...
ALTER TABLE `bill`
  ...
  ADD CONSTRAINT `FK_Phone` FOREIGN KEY (`Cus_Phone`) REFERENCES `customer` (`Phone`),
...
ALTER TABLE `order_details`
  ...
  ADD CONSTRAINT `FK_item` FOREIGN KEY (`item_ID`) REFERENCES `food&drink_category` (`ID`);
COMMIT;
